    ...
    <nav className="border-gray-200 dark:bg-gray-900 dark:border-gray-700 ">
      <div className="md:max-w-full flex flex-wrap justify-between md:justify-start mx-auto p-4">
        <Link to="#" className="flex md:items-start space-x-3 rtl:space-x-reverse">
          ...
          <span className="md:hover:text-white md:hover:scale-125 self-start text-2xl font-semibold whitespace-nowrap dark:text-white">LOGO</span>
        </Link>
              ...
              {isDropdownOpen && (
                <div id="dropdownNavbar" className="bg-orange-400 w-full md:w-44 md:absolute z-10 font-black text-lg divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
                  <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                    ...
                    <li>
                      <Link to="/SiddhanathSuryaYoga" onClick={handleLinkClick} className="block px-4 py-2 text-start hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Siddhanath Surya Yoga</Link>
                    </li>
                    <li>
                      <Link to="/SiddhanathHamsaYoga" onClick={handleLinkClick} className="block px-4 py-2 text-start hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Siddhanath Hamsa Yoga</Link>
                    </li>
                    <li>
                      <Link to="/EarthPeaceMeditation" onClick={handleLinkClick} className="block px-4 py-2 text-start hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Earth Peace Meditation</Link>
                    </li>
                    <li>
                      <Link to="/Yoga" onClick={handleLinkClick} className="block px-4 py-2 text-start hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Yoga</Link>
                    </li>
                  </ul>
                </div>
              )}
              ...
              {eventDropdownOpen && (
                <div id="dropdownNavbar" className="bg-orange-400 w-full md:w-44 md:absolute z-10 font-black text-lg divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
                  <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                    ...
                    <li>
                      <Link to="/" onClick={handleLinkClick} className="block px-4 py-2 text-start hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Event2</Link>
                    </li>
                  </ul>
                </div>
              )}
